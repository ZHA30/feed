...
async function main(): Promise<void> {
  ...
  if (staged.length === 0) {
    console.log("No transfeed state changes to commit.");
    return;
  }
  ...
  await exec("git", ["commit", "-m", "chore(transfeed): update state [skip ci]", "-m", "Update translation cache generated by Transfeed."], { cwd: stateDir });
